...
from src.problem.pdtsp.learning.brain_ppo import BrainPPO
...
class TrainerPPO:
    """
    Definition of the Trainer PPO for the PDTSP
    """
    ...
    def __init__(self, args):
        ...
        self.validation_set = PDTSP.generate_dataset(size=VALIDATION_SET_SIZE, n_city=self.args.n_city, m_commodity=self.args.m_commodity,
                                                     ...
                                                     capacity_looseness=self.args.capacity_looseness,
                                                     seed=np.random.randint(10000), is_integer_instance=False)
